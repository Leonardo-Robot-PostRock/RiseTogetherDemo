...
import com.risetogether.jobs.domain.event.JobCreatedEvent;
...
public class JobAggregate extends AggregateRoot {
  ...
  /**
   * Links this job to an {@link com.risetogether.profiles.domain.aggregate.EmployerAggregate} if not already linked.
   *
