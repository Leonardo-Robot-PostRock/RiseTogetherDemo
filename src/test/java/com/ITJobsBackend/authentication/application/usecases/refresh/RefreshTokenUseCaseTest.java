...
class RefreshTokenUseCaseTest {
  ...
  void shouldGenerateNewTokens() {
    ...
    given(queryUserPort.findById(any())).willReturn(Optional.of(buildUserView()));
    ...
    then(queryUserPort).should().findById(any());
  }
  ...
  void shouldThrowWhenUserNotFound() {
    ...
    // When & Then
    assertThrows(IllegalArgumentException.class, () -> refreshTokenUseCase.execute(REFRESH_TOKEN));
  }
}
