...
public class SecurityExceptionHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    public void commence(
        ...
        writeErrorResponse(response, HttpStatus.UNAUTHORIZED, "Unauthorized", authException.getMessage());
    }
    @Override
    public void handle(
        HttpServletRequest request, 
        ...
        log.warn("Access denied - IP: {}, URI: {}, reason: {}", 
            request.getRemoteAddr(), request.getRequestURI(), accessDeniedException.getMessage());
    ...
    private void writeErrorResponse(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                status.value(), error, message, Instant.now()
        );
